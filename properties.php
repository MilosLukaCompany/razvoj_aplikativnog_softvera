            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title">pregled nekretnina</h1>               
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="blog-asside-right pr0">
                        <div class="panel panel-default sidebar-menu wow fadeInRight animated" >
                            ...
                            <div class="panel-body search-widget">
                                <form action="php/filter.php" action="POST" class=" form-inline">                                     
                    ...
                    <div class="col-md-12 clear"> 
                        <div id="list-type" class="proerty-th">                                                            
                            ...
                            if ($last_page !== 1) {
                                if ($page_num > 1) {
                                    $previous = $page_num - 1;
                                    $pagination_ctrl .= "<li><a href='" . $_SERVER['PHP_SELF'] . "?pn=" . $previous . "'>Prethodna</a></li>\n";
...
//                                $pagination_ctrl .= "" . $page_num;
                            ...
                            foreach ($res_property as $property) {
                                ...
                                echo "<h5><a href='property_view.php'> " . $property->adresa . "</a></h5>\n";
